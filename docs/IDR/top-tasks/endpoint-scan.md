...
Rapid7 recommends using the Insight Agent instead of the Endpoint Scan. The Insight Agent collects real-time data, is capable of more detections, and allows you to use [scheduled forensics](https://insightidr.help.rapid7.com/docs/scheduled-forensics). See the [Insight Agent](https://insightagent.help.rapid7.com/docs/overview) documentation for Insight Agent deployment instructions.
